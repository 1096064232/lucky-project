...
public class AliPCPayServiceImpl extends AbstractPayService {
    ...
    public void tradeClose(ServletWebRequest servletWebRequest) {
        ...
        TradeClsoeResponse tradeClsoeResponse = paymentProcessorHolder.findPaymentProcessor(PaymentTypeEnum.ALI_PC_WEB).tradeClose(servletWebRequest,tradeCloseRequest);
